...
4. If the item is an operator (e.g. + or ÷), 
    4a. Pop the top element off the stack (b)
    4b. Pop the top element off the stack (a)
    4c. Compute and push (a operator b) to the stack
...
`,
`
The simplicity of this algorithm is why it is used in some programming languages, such as PostScript.
`
            ],
