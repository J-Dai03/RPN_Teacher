...
export default class EvalEntryScene extends Phaser.Scene {
    constructor() {

        super({ key: 'EvalEntryScene' });
        this.title = 'Enter an RPN expression to be evaluated';
    ...
    startSlide(){
        this.scene.start('EvalSlidesScene', { expression : this.expression });
    }
}